...
int main()
{
    ...
    do{
        ...
        switch (opcion){
            case 1: //AÃ±ade un elemento al final de la lista
            ...
            case 2: // AÃ±ade un elemnto al inicio de la lista
            ...
            case 7://busca un elemnto a travÃ©s del induce de la lista

                    while(a){
                    cout << "Introduce el elemento que quieres buscar por el indice: ";
                    cin  >> dato;
                    cout << "Esta en la posiciÃ³n del indice: " << head->at(dato) << endl;
                    cout <<"Si quieres introducir otro numero" << endl;
                    cout <<"1) SI " << endl;
                    cout <<"0) NO " <<endl << endl;
